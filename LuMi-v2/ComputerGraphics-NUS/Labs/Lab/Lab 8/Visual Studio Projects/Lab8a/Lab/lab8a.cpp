...
{
	gModelMatrix = glm::rotate(glm::radians(gRotateX), glm::vec3(1.0f, 0.0f, 0.0f));
}
...
TwBar* create_UI(const std::string name)
{
	...
	// object rotation
	TwAddVarRW(twBar, "Rotation", TW_TYPE_FLOAT, &gRotateX, " group='Transformation' min=-180 max=180 step=1 ");
